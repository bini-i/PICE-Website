...
export default function Home() {
  ...
  return (
    <>
      ...
      <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Productivity+Improvement+and+Center+of+Excellence+(ምርታማነት+ማሻሸያና+የልዕቀት+ማዕከል)" width="100%" height="350" ></iframe>
